...
- Keep the static onboarding wizard as a guide layer only: no upload, backend, API key, paid-service dependency, or private thesis intake.
...
- Add safe/unsafe AI paste examples and de-identification prompts for thesis excerpts.
- Add an AI usage log template for agent-assisted writing and literature work.
...
- Maintain the static onboarding wizard and add first-30-minute checklists for each student stage.
...
- Add a source/evidence registry that can track DOI or URL, database/tool, search date, verification status, and supporting quote/page/paragraph.
...
- [ ] A public first-use page explains what students can do without API keys, paid services, uploads, or private text exposure.
- [ ] A competitor survey and backlog explain why the project targets workflow orchestration rather than official formatting or live literature search.
